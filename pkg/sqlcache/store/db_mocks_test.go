...
// Source: github.com/rancher/steve/pkg/sqlcache/db (interfaces: Rows,Client,TxClient,Stmt)
//
// Generated by this command:
//
//	mockgen --build_flags=--mod=mod -package store -destination ./db_mocks_test.go github.com/rancher/steve/pkg/sqlcache/db Rows,Client,TxClient,Stmt
//
